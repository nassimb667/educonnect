...
<body class="bg-gray-100">
    <div class="container mx-auto p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <a href="controller_login_educ.php" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-lg text-center">Version Éducateur/e</a>
            <a href="controller_signin.php" class="bg-green-500 hover:bg-green-700 text-white font-bold py-4 px-8 rounded-lg text-center">Version Famille</a>
        </div>
