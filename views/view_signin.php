    ...
    <div class="max-w-md w-full bg-white p-8 rounded shadow-md">
        ...
        <form method="POST">
            ...
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="../controllers/controller_signup.php" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">Pas encore inscrit?</a>
            </div>

            <!-- Bouton pour retourner vers le contrôleur "controller_who" -->
            <div class="text-center">
                <a href="../controllers/controller_who.php" class="text-sm text-gray-500 hover:text-gray-700">Retour</a>
            </div>
        </form>
    </div>
</body>
